...
data class WeatherData(
    ...
    val time: String get() = getTimeFormatted(responseWeatherData.locationDto?.localtime) ?: String.EMPTY
    val data: String
        get() = getDateFormatted(responseWeatherData.locationDto?.localtime) ?: String.EMPTY
    ...
    val condition: String get() = responseWeatherData.forecastDataDto?.forecastDayDto?.get(0)?.dayDto?.conditionDTO?.text?: String.EMPTY
    @get:DrawableRes
